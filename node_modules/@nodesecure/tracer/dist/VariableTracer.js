...
import { getMemberExpressionIdentifier, getCallExpressionIdentifier, getCallExpressionArguments, getVariableDeclarationIdentifiers, extractLogicalExpression, isLiteral } from "@nodesecure/estree-ast-utils";
import { match } from "ts-pattern";
// Import Internal Dependencies
import { notNullOrUndefined, isEvilIdentifierPath, isNeutralCallable, getSubMemberExpressionSegments, makePrefixRemover, stripNodePrefix } from "./utils/index.js";
// CONSTANTS
...
export class VariableTracer extends EventEmitter {
    ...
    #declareNewAssignment(identifierOrMemberExpr, id) {
        ...
        this.emit(_a.AssignmentEvent, assignmentEventPayload);
    ...
    #reverseAtob(node, id) {
        ...
        if (typeof callExprArgumentNode === "string") {
            this.literalIdentifiers.set(id.name, Buffer.from(callExprArgumentNode, "base64").toString());
        }
    }
